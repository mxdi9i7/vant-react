...
export default class ResultList extends Component {
  ...
  render() {
    ...
    if (isEmpty(matches)) {
      return (
        <div className="van-doc-search-box-result-list van-doc-search-box-result-list--no-result">
    ...
    return (
      <ul
        className="van-doc-search-box-result-list"
      ...
      >
        {matches.map((item, idx) => {
          ...
          return (
            <li
              key={path}
              className={cx('van-doc-search-box-result-item', {
                'van-doc-search-box-result-item__active':
                  idx === activeIndex,
              })}
              onClick={() => redirectToResult(item)}
            >
              <span className="van-doc-search-box-result-item__title">
                {title}
              </span>
              {subtitle && (
                <span className="van-doc-search-box-result-item__subtitle">
                  {subtitle}
                </span>
              )}
            </li>
